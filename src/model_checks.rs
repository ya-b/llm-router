...
pub async fn perform_model_checks(
    ...
    use crate::converters::gemini::{
        GeminiRequest, gemini_content::GeminiContent,
        gemini_generation_config::GeminiGenerationConfig, gemini_part::GeminiPart,
    };
    ...
    use crate::converters::responses::{
        ResponsesInput, ResponsesMessage, ResponsesMessageContent, ResponsesRequest,
    };
                ...
                let request = match mc.llm_params.api_type {
                    ...
                    ApiType::Responses => {
                        let req = ResponsesRequest {
                            model: mc.model_name.clone(),
                            input: ResponsesInput::Messages(vec![ResponsesMessage {
                                role: "user".to_string(),
                                content: ResponsesMessageContent::Text("ping".to_string()),
                                r#type: None,
                                id: None,
                                status: None,
                                name: None,
